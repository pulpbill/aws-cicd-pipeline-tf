...
# Policies attached to our previous codepipeline role that will allow us
# to use all the necessary services (S3 - CW - CodeBuild)
...
# Create a CodeBuild Role and policies; same as you did for CodePipeline before
